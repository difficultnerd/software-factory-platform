...
export const AGENT_CONFIGS: Record<AgentName, AgentConfig> = {
  spec:             { model: 'claude-sonnet-4-5-20250929', maxTokens: 16000 },
  planner:          { model: 'claude-sonnet-4-5-20250929', maxTokens: 24000 },
  contract_test:    { model: 'claude-sonnet-4-5-20250929', maxTokens: 24000 },
  implementer:      { model: 'claude-opus-4-6-20250910',  maxTokens: 128000 },
  security_review:  { model: 'claude-sonnet-4-5-20250929', maxTokens: 12000 },
  code_review:      { model: 'claude-sonnet-4-5-20250929', maxTokens: 12000 },
